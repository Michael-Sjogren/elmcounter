...
var $author$project$Main$MsgCounterA = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$MsgCounterB = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 1:
				var cmsg = msg.a;
				var _v1 = A2($author$project$Counter$update, cmsg, model.l);
				var counterA = _v1.a;
				var aCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 2:
				...
				var counterB = _v3.a;
				var bCmd = _v3.b;
				var _v4 = A2($author$project$Counter$update, $author$project$Counter$Reset, model.l);
				var counterA = _v4.a;
				var aCmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				...
				var counterB = _v5.a;
				var bCmd = _v5.b;
				var _v6 = A2($author$project$Counter$update, $author$project$Counter$Randomize, model.l);
				var counterA = _v6.a;
				var aCmd = _v6.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$MsgResetAll = {$: 2};
...
var $author$project$Components$primaryBtnCls = 'py-2 px-4 text-white bg-indigo-600 hover:bg-indigo-700 cursor-pointer rounded-md text-lg';
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Counter$Decrement = {$: 1};
var $author$project$Counter$Increment = {$: 0};
var $author$project$Components$secondaryBtnCls = 'py-2 px-4 text-indigo-700 border-1 border-indigo-600 bg-white hover:bg-neutral-100 cursor-pointer rounded-lg text-sm';
var $elm$html$Html$span = _VirtualDom_node('span');
var $elm$html$Html$button = _VirtualDom_node('button');
var $author$project$Components$viewButton = function (d) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				d.as,
				$elm$html$Html$Attributes$class(d.ap)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(d.aD)
			]));
};
var $author$project$Counter$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('flex gap-8 items-center')
			]),
		_List_fromArray(
			[
				$author$project$Components$viewButton(
				{
					ap: $author$project$Components$primaryBtnCls,
					as: $elm$html$Html$Events$onClick($author$project$Counter$Decrement),
					aD: '-'
				}),
				A2(
				$elm$html$Html$span,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('min-w-12 text-center bg-neutral-100 p-3 rounded-sm')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
				...
				{
					ap: $author$project$Components$primaryBtnCls,
					as: $elm$html$Html$Events$onClick($author$project$Counter$Increment),
					aD: '+'
				}),
				$author$project$Components$viewButton(
				{
					ap: $author$project$Components$secondaryBtnCls,
					as: $elm$html$Html$Events$onClick($author$project$Counter$Randomize),
					aD: 'Randomize'
				}),
				$author$project$Components$viewButton(
				{
					ap: $author$project$Components$secondaryBtnCls,
					as: $elm$html$Html$Events$onClick($author$project$Counter$Reset),
					aD: 'Reset'
				})
			]));
};
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('min-h-100wh')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('grid gap-4 px-4 py-4 justify-center')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-neutral-700 text-2xl font-light text-center')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('ELM App Counter')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('flex gap-8')
							]),
						_List_fromArray(
							[
								$author$project$Components$viewButton(
								{
									ap: $author$project$Components$primaryBtnCls,
									as: $elm$html$Html$Events$onClick($author$project$Main$MsgResetAll),
									aD: 'Reset all'
								}),
								$author$project$Components$viewButton(
								{
									ap: $author$project$Components$primaryBtnCls,
									as: $elm$html$Html$Events$onClick($author$project$Main$MsgRandomizeAll),
									aD: 'Randomize all'
								})
							])),
						A2(
						$elm$html$Html$map,
						$author$project$Main$MsgCounterA,
						$author$project$Counter$view(model.l)),
						A2(
						$elm$html$Html$map,
						$author$project$Main$MsgCounterB,
						$author$project$Counter$view(model.m))
					]))
			]));
};
